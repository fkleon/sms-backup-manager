...
/**
 * The SettingsDialogView is a {@link View} on a {@link de.leonhardt.sbm.gui.common.SettingsPM}.
 *
...
public class SettingsDialogView extends JDialog implements View<SettingsPM> {
	...
	private final IconLoader il; //TODO put icon logic into PM
	
	/**
	 * Constructs a new <code>SettingsDialog</code>.
	 */
	public SettingsDialogView(Frame parent) {
		...
		this.setLocationRelativeTo(parent); // center
	}
